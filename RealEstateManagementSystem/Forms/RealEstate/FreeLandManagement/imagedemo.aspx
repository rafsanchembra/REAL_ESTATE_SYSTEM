<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Content/WindowMaster.Master" CodeBehind="imagedemo.aspx.vb" Inherits="RealEstateManagementSystem.imagedemo" %>
        ...
        <div class="wrapper">
            <msg:PopMsg ID="PopMsg" runat="server" />
                        ...
                        <div class="col-row sg-text-align-center">
                            <div class="col-10  ">
                                <telerik:RadImageGallery ID="RadImageGallery1" runat="server" RenderMode="Classic" ImagesFolderPath="images" Width="512px" Height="480px">
