<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Content/WindowMaster.Master" CodeBehind="BuldingFlatAttachmentWindow.aspx.vb" Inherits="RealEstateManagementSystem.BuldingFlatAttachmentWindow" %>
    ...
    <div id="Master_Div">
        <div class="wrapper">
            ...
            <div class="col-row sg-text-align-center">
                <div class="col-10  ">
                    <telerik:RadImageGallery ID="BuildingFlatRadImage" runat="server" RenderMode="Classic"  Width="1024px" Height="650px">
