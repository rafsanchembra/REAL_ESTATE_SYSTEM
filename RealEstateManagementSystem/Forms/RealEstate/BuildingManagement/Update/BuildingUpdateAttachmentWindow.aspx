<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Content/WindowMaster.Master" CodeBehind="BuildingUpdateAttachmentWindow.aspx.vb" Inherits="RealEstateManagementSystem.BuildingUpdateAttachmentWindow" %>
                    ...
                    <div class="col-10 tabMain">
                        <telerik:RadMultiPage runat="server" ID="BuildingAttachmentMultiPage" SelectedIndex="0">
                            <telerik:RadPageView runat="server" ID="ImagePageView" Selected="true">
                                    ...
                                    <div class="col-4">
                                        <div class="sg-blockcontent-right">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <asp:HyperLink runat="server" ID="ViewHyperLink" Text="View" Visible="false" Target="_blank" />
                                            </div>
                                            <div class="col-10 sg-label">
                                            ...
                                            <div class="col-10 sg-label">
                                                <asp:Label runat="server" ID="ImageQualityLabel" Text="Image Quality" AssociatedControlID="ImageRating" />
                                            </div>
                                            <div class="col-10 sg-textbox-required-field">
                                                <telerik:RadRating RenderMode="Lightweight" ID="ImageRating" runat="server" ItemCount="10"
                                ...
                                <div class="col-10 sg-textbox-required-field">
                                    <telerik:RadImageEditor RenderMode="Lightweight" CanvasMode="No" ID="AttachmentImageEditor" Enabled="false" runat="server" Width="1024px" Height="720" OnImageLoading="AttachmentImageEditor_ImageLoading" OnImageSaving="AttachmentImageEditor_ImageSaving"
