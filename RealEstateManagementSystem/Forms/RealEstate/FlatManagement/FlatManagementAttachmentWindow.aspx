<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Content/WindowMaster.Master" CodeBehind="FlatManagementAttachmentWindow.aspx.vb" Inherits="RealEstateManagementSystem.FlatManagementAttachmentWindow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <div id="Master_Div">
        <div class="wrapper">
            ...
            <div class="col-10 sg-block-window">
                <div class="col-10  ">
                    <telerik:RadImageGallery ID="FlatRadImage" runat="server" RenderMode="Classic" Width="1024px" Height="650px">
